/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-dark&languages=markup+css+clike+javascript+c+cpp+docker+go+go-module+java+json+json5+lua+markdown+python+rust+typescript+zig */
var _self =
